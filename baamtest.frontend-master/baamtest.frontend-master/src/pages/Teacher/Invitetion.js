...
class Invitetion extends React.Component {
  ...
  finalActivate = () => {
    ...
    payment(toEn(parseInt(this.state.price.replace(/,/g, ""))), token).then(
      res => {
        console.warn(res);
        if (res.isSuccess) {
              ...
              >
                <div>
                  <div style={{ fontSize: "1rem", padding: "0 15px" }}>
                    برای شما که در خیلی سبز ثبت نام کرده اید ،یک کد دعوت فعال شده
                    است که می‌توانید با آن از دوستان خود دعوت کنید که در خیلی سبز
                    به جمع بزرگ ما بپیوندند. این کد دعوت را می توانید به تمام
                    مدارس، موسسات، مشاوران،دبیران و دانش آموزان بدهید و آن ها با
                    استفاده از کد دعوت شما در اولین خرید خود ،تخفیف دریافت کنند
                    و شما به عنوان دعوت کننده ،از خیلی سبز ستاره دریافت کنید که
                    این ستاره ها در نهایت می توانند به هدایای نفیسی از طرف بام
                    تست به شما تبدیل شود؛ برای اطلاعات بیشتر می توانید با بخش
                    پشتیبانی تماس حاصل بفرمایید{" "}
                  </div>
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        alignItems: "center",
                        height: 40,
                        boxShadow: "0 0 1vw -0.25vw #0000003d",
                      }}
                    >
                      {this.state.code}
                    </div>
