...
class RegisterTest extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <PageTitle title={`افزایش اعتبار (برای ${getUserTypeStr(this.state.userType)})`} />
                <Grid container item xs={12} style={{padding: '0 10px'}}>
                    ...
                    <Grid direction="column" container item xs={12}>
                        <div style={{flexDirection: 'row', display: 'flex', width: '100%'}}>
                            <div>
                                <div style={{width: '100%'}}>
                                    <PageTitle title="قوانین" size="h2" color="#3d82a4" />
                                </div>
                                <div style={{fontSize: '1rem', padding: '0 15px'}}>
                                برای بهره گیری از کلیه ی خدمات بام تست ،می توانید اعتبار خود را افزایش دهید و از آن در بخش های مختلف استفاده کنید و در ازای آن ستاره دریافت کنید که این ستاره ها در نهایت به هدایای نفیسی از طرف بام تست به شما تبدیل می شود؛ برای اطلاعات بیشتر می‌توانید با بخش پشتیبانی تماس حاصل بفرمایید‌.
                                </div>
                            </div>
                    ...
                    <div style={{display: 'flex', width: '100%', flexDirection: 'row', justifyContent: 'space-between',}}>
                        <div style={{flexDirection: 'row', display: 'flex', background: '#fff', height: 45, borderRadius: 50, alignItems: 'center', justifyContent: 'space-between'}}>
                            ...
                            <div style={{flex: 1, textAlign: 'center', minWidth: 200}}>
                                <span style={{fontSize: 17, minWidth: 200, padding: '0 25px', textAlign: 'center'}}>{toFA(this.state.star)}</span>
                            </div>
                        </div>
                        <div style={{flex: 1}} />
                        <div style={{flexDirection: 'row', display: 'flex', background: '#fff', height: 45, borderRadius: 50, alignItems: 'center', justifyContent: 'space-between'}}>
                            ...
                            <div style={{flex: 1, textAlign: 'center', width: 200}}>
                                <span style={{fontSize: 17, width: 200, textAlign: 'center'}}>{toFA((this.state.credit).toLocaleString())} تومان</span>
                            </div>
                        </div>
                        <div style={{flex: 1}} />
                    </div>
                    ...
                    <div style={{display: 'flex', width: '100%', flexDirection: 'row', justifyContent: 'space-between',}}>
                        <div style={{flexDirection: 'row', display: 'flex', background: '#fff', height: 45, borderRadius: 50, alignItems: 'center', justifyContent: 'space-between'}}>
                            ...
                            <div style={{flex: 1, textAlign: 'center', width: 300}}>
                                <span style={{fontSize: 17, width: 300, textAlign: 'center', display: 'flex', alignItems: 'center', padding: '0 15px'}}>{
                                    <TextField
