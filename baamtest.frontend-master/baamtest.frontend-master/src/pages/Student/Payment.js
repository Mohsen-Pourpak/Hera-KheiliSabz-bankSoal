      ...
      <>
        {!this.state.paymentInfo ? (
          ...
          <Grid
            ...
            item
            xs={12}
            style={{ padding: "0 10px", marginTop: 40 }}
          >
            <Grid
              direction="column"
            ...
            >
              ...
              >
                ...
                >
                  مبلغ : {toFA(this.state.paymentInfo.amount.toLocaleString())}{" "}
                  تومان
                </div>
                <div
                  style={{ textAlign: "center", fontSize: 20, marginTop: 20 }}
                ...
                >
                  تاریخ و ساعت :{" "}
                  {toFA(this.state.paymentInfo.createDate.replace(" ", " - "))}
                </div>
                <Grid
                  direction="row"
                  justify="center"
