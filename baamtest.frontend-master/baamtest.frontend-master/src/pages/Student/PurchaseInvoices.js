        ...
        return (
          ...
          >
            ...
            <div style={{ ...styles.trItem, width: 150 }}>
              {toFA(item.totalAmount.toLocaleString())} تومان
            </div>
            <div style={{ ...styles.trItem, width: 210 }}>
              {
                PRODUCT_TYPES.filter(el => el.value === item.productType)[0]
                  .title
              }
            </div>
            <div
              style={{
                ...styles.trItem,
                width: 100,
                backgroundColor: item.isFinaly ? "#deffd5" : "#ffebe4",
                color: item.isFinaly ? "#329455" : "#ec6058",
              }}
            >
              {item.isFinaly ? (
                <CheckCircle
              ...
              {item.isFinaly ? "تمام شده" : "تمام نشده"}
            </div>
            <div
              style={{
                backgroundColor: "#f4faff",
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      <div>
                        تاریخ ایجاد: {getDateTime(selectedInvoice.createTime)}
                      </div>
                      <div>
                        تاریخ نهایی سازی:{" "}
                        {getDateTime(selectedInvoice.submittedTime)}
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div style={{ fontSize: 16, flex: 2, textAlign: "center" }}>
                      وضعیت
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <div style={{ fontSize: 16, flex: 1, textAlign: "center" }}>
                      {toFA(selectedInvoice.count)}
                    </div>
                    <div style={{ fontSize: 16, flex: 3, textAlign: "center" }}>
                      {toFA(selectedInvoice.amount.toLocaleString())} تومان
                    </div>
                    <div style={{ fontSize: 16, flex: 2, textAlign: "center" }}>
                      {selectedInvoice.isFinaly ? "تمام شده" : "تمام نشده"}
                    </div>
                  </div>
                  <div style={{ width: "100%", display: "flex" }}>
                    ...
                    >
                      <div
                        style={{ fontSize: 16, flex: 3, textAlign: "center" }}
                      >
                        مالیات:{" "}
                      </div>
                      <div
                        style={{ fontSize: 16, flex: 3, textAlign: "center" }}
                      >
                        {toFA(selectedInvoice.tax.toLocaleString())} تومان
                      </div>
                    </div>
                  </div>
                  <div style={{ width: "100%", display: "flex" }}>
                    ...
                    >
                      ...
                      <div
                        style={{ fontSize: 16, flex: 3, textAlign: "center" }}
                      >
                        {toFA(selectedInvoice.discountAmount.toLocaleString())}{" "}
                        تومان
                      </div>
                    </div>
                  </div>
                  <div style={{ width: "100%", display: "flex" }}>
                    ...
                    >
                      ...
                      >
                        {toFA(selectedInvoice.totalAmount.toLocaleString())}{" "}
                        تومان
                      </div>
                    </div>
                  </div>
