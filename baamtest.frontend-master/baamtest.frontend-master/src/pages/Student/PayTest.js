              ...
              <Grid direction="column" container item xs={12}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ ...styles.thItem, flex: 2 }}>
                        تعداد سوال
                      </div>
                      <div style={{ ...styles.thItem, flex: 2 }}>
                        قیمت (تومان)
                    ...
                    >
                      ...
                      <div style={{ ...styles.trItem, flex: 2 }}>
                        {toFA(
                          this.state.exam.questionsIdsAndNumbers.length *
                            QUESTION_PRICE,
                        ).toLocaleString()}
                      </div>
                    </div>
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ ...styles.trItem, padding: 15 }}>
                      {toFA(
                        this.state.exam.questionsIdsAndNumbers.length *
                          QUESTION_PRICE,
                      ).toLocaleString()}
          ...
          >
            ...
            >
              {!this.state.isSchool && this.state.heads.length !== 0 && (
                <>
                  ...
                  {this.state.headId !== "none" && (
                    ...
                    >
                      آیا از پرداختن با شارژ "
                      {
                        this.state.heads.filter(
                          el => el.id === this.state.headId,
                        )[0].title
                      }
                      " اطمینان دارید؟
                    </div>
              ...
              {this.state.headId !== "none" && (
                <div>
                  <div
                    onClick={() => this.setState({ headId: "none" })}
                    style={{
                      flexDirection: "row",
                      display: "flex",
                      background: "#fe5f55",
              ...
              <div>
                <div
                  onClick={this.finalRegisterExam}
                  style={{
                    flexDirection: "row",
                    display: "flex",
                    background: "#228B22",
