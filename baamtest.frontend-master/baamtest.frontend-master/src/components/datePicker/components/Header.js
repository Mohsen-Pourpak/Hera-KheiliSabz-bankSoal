...
const Header = ({
  ...
  return (
    <div ref={headerElement} style={{flexDirection: 'column', overflow: 'visible'}} className="Calendar__header">
      <div style={{display: 'flex', justifyContent: 'space-between', paddingLeft: '5%', width: '100%'}}>
        <div style={{padding: '13px 16px', color: '#fff', fontSize: '1vw'}}>تقویم آزمون ها</div>
        <div
      ...
      <div style={{display: 'flex', justifyContent: 'space-between', height: 20, marginTop: -20, width: '100%'}}> 
        <button
